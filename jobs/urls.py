...
from .views import JobListView, JobDetailView, JobCreateView, JobUpdateView, JobDeleteView, job_bid_view, FileUploadView#, job_upload_view
from . import views
...
urlpatterns = [
    ...
    path('job/<int:pk>/upload/', FileUploadView.as_view(), name='job-upload-file'),
