...
from .views import JobListView, JobDetailView, JobCreateView, JobUpdateView, JobDeleteView, job_active_view, job_bid_view, job_accept_view #, JobBidAcceptView
from . import views
...
urlpatterns = [
    ...
    path('job/<int:pk>/bid/accept/', views.job_accept_view, name='job-bid-accept'),
    #path('job/<int:pk>/bid/accept/', JobBidAcceptView.as_view(), name='job-bid-accept'),
