...
from .views import JobListView, JobDetailView, JobCreateView, JobUpdateView, JobDeleteView, BidCreateView
from . import views
...
urlpatterns = [
    ...
    path('job/<int:pk>/bid/', BidCreateView.as_view(), name='job-bid'),
